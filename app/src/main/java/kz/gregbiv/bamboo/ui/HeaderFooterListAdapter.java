...
public class HeaderFooterListAdapter<E extends BaseAdapter> extends HeaderViewListAdapter {
    ...
    private HeaderFooterListAdapter(final ArrayList<FixedViewInfo> headerViewInfos,
                                    final ArrayList<FixedViewInfo> footerViewInfos, final ListView view,
                                    final E adapter) {
     ...
     * @return this adapter
     */
    public HeaderFooterListAdapter<E> addFooter(final View view, final Object data, final boolean isSelectable) {
        final FixedViewInfo info = list.new FixedViewInfo();
    ...
    public boolean clearHeaders() {
        ...
        if (!headers.isEmpty()) {
            final FixedViewInfo[] infos = headers.toArray(new FixedViewInfo[headers.size()]);
    ...
    public boolean clearFooters() {
        ...
        if (!footers.isEmpty()) {
            final FixedViewInfo[] infos = footers.toArray(new FixedViewInfo[footers.size()]);
