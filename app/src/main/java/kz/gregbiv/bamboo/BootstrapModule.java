...
import kz.gregbiv.bamboo.authenticator.LogoutServiceImpl;
import kz.gregbiv.bamboo.core.BootstrapService;
import kz.gregbiv.bamboo.core.Constants;
import kz.gregbiv.bamboo.core.PostFromAnyThreadBus;
import kz.gregbiv.bamboo.core.RestAdapterRequestInterceptor;
import kz.gregbiv.bamboo.core.RestErrorHandler;
import kz.gregbiv.bamboo.core.UserAgentProvider;
...
public class BootstrapModule {
    ...
    RestAdapter provideRestAdapter(RestErrorHandler restErrorHandler,
        ...
        return new RestAdapter.Builder().setEndpoint(Constants.Http.URL_BASE).setErrorHandler(
            restErrorHandler).setRequestInterceptor(restRequestInterceptor).setLogLevel(
            RestAdapter.LogLevel.FULL).setConverter(new GsonConverter(gson)).build();
    }
}
