...
import static kz.gregbiv.bamboo.authenticator.BootstrapAuthenticatorActivity.PARAM_AUTHTOKEN_TYPE;
...
class BootstrapAccountAuthenticator extends AbstractAccountAuthenticator {
     ...
     * {@link kz.gregbiv.bamboo.authenticator.ApiKeyProvider#getAuthKey(android.app.Activity)}
    ...
    public String getAuthTokenLabel(final String authTokenType) {
        return authTokenType.equals(Constants.Auth.AUTHTOKEN_TYPE)
               ? authTokenType
               : null;
    }
