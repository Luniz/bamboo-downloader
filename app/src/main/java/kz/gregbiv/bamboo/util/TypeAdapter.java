...
public abstract class TypeAdapter extends BaseAdapter {
    ...
    /**
     * Set text color on text view at given index
     *
     * @param childViewIndex
     * @param resId
     * @return text view
     */
    protected TextView setColor(final int childViewIndex, final int resId) {
        return updater.setColor(childViewIndex, resId);
    }
